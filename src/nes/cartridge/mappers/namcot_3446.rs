...
impl Namcot3446 {
    pub fn new(mut core: CartridgeCore) -> Self {
        core.chr_ram.set_bank_size_k(2);
        ...
        result.registers[2] = 2;
        result.registers[3] = 3;
        result.registers[4] = 4;
        result.registers[5] = 5;
    ...
    fn reconfigure_banks(&mut self) {
        self.core
            .chr_ram
            .set_bank(0, (self.registers[2] & 0b0011_1111) as i16);
        self.core
            .chr_ram
            .set_bank(1, (self.registers[3] & 0b0011_1111) as i16);
        self.core
            .chr_ram
            .set_bank(2, (self.registers[4] & 0b0011_1111) as i16);
        self.core
            .chr_ram
            .set_bank(3, (self.registers[5] & 0b0011_1111) as i16);

        self.core
            .prg_rom
            .set_bank(0, (self.registers[6] & 0b0011_1111) as i16);
        self.core
            .prg_rom
            .set_bank(1, (self.registers[7] & 0b0011_1111) as i16);
