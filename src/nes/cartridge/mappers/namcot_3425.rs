...
impl Namcot3425 {
    ...
    fn reconfigure_banks(&mut self) {
        self.core
            .chr_ram
            .set_bank(0, (self.registers[0] & 0b0001_1110) as i16);
        self.core
            .chr_ram
            .set_bank(1, (self.registers[0] & 0b0001_1110) as i16 + 1);
        self.core
            .chr_ram
            .set_bank(2, (self.registers[1] & 0b0001_1110) as i16);
        self.core
            .chr_ram
            .set_bank(3, (self.registers[1] & 0b0001_1110) as i16 + 1);
        self.core
            .chr_ram
            .set_bank(4, (self.registers[2] & 0b0001_1111) as i16);
        self.core
            .chr_ram
            .set_bank(5, (self.registers[3] & 0b0001_1111) as i16);
        self.core
            .chr_ram
            .set_bank(6, (self.registers[4] & 0b0001_1111) as i16);
        self.core
            .chr_ram
            .set_bank(7, (self.registers[5] & 0b0001_1111) as i16);
        ...
        self.core
            .vram
            .set_bank(0, ((self.registers[0] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(1, ((self.registers[0] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(2, ((self.registers[1] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(3, ((self.registers[1] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(4, ((self.registers[0] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(5, ((self.registers[0] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(6, ((self.registers[1] >> 5) & 1) as i16);
        self.core
            .vram
            .set_bank(7, ((self.registers[1] >> 5) & 1) as i16);
    }
