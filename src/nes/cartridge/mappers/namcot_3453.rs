...
impl Namcot3453 {
    ...
    fn configure(&mut self, addr: u16, value: u8) -> u8 {
        self.mirror_mode = (value >> 6) & 1;
        match addr {
            0x8000..=0x9FFE if addr & 1 == 0 => {
                let old = self.set_bank_select(value & 0b0000_0111);
    ...
    fn reconfigure_banks(&mut self) {
        ...
        self.core
            .chr_ram
            .set_bank(4, ((self.registers[2] & 0b0011_1111) | 0b0100_0000) as i16);
        self.core
            .chr_ram
            .set_bank(5, ((self.registers[3] & 0b0011_1111) | 0b0100_0000) as i16);
        self.core
            .chr_ram
            .set_bank(6, ((self.registers[4] & 0b0011_1111) | 0b0100_0000) as i16);
        self.core
            .chr_ram
            .set_bank(7, ((self.registers[5] & 0b0011_1111) | 0b0100_0000) as i16);
